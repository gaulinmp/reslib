...
Uses reslib.dag.code_parser.CodeParser objects to extract comments from code, then calculates the dependency graph.
...
from reslib.dag.code_parser import SAS, Stata, Notebook, Python
...
class DependencyScanner:
    ...
    Examples:
        ...
        Then the following would create a graph output at pipeline.pdf::
            ...
            from reslib.dag import DependencyScanner
        ...
        Alternatively, a one-liner on the commandline:
            ...
            python -c "from reslib.dag import *;DependencyScanner(code_path_prefix='data', data_path_prefix='code').DAG_to_file('pipeline')"
    """
